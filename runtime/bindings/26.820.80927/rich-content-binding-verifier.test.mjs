...
test("pins four unique exact-build assets with complete SHA-256 values", () => {
  assert.equal(RICH_CONTENT_BINDING.assets.length, 4);
  assert.equal(
